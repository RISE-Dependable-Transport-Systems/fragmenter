...
I'm the maintainer of the WayWise library, which is an open-source autonomous vehicle software stack. I need you to help me create a comprehensive exploitation plan and a complete `main.cpp` test file that demonstrates a critical vulnerability in the WayWise codebase related to GNSS spoofing so that I can understand the risks and implement necessary mitigations.
...
An example of a working `main.cpp`file that compiles and runs is. This does not demonstrate the vulnerability but serves as a template for structure and needed parts.
